...
///////////////////////////////////////////////////////////////////////////////////////////////	
	...
	// ACTORS
	  ...
	  // IMAGE GAME TABLE
		...
		System.out.println("world" + stage.getViewport().getWorldWidth()+"," + stage.getViewport().getWorldHeight());
		System.out.println("world" + stage.getViewport().getViewportWidth()+"," + stage.getViewport().getViewportHeight());
		System.out.println("width" + iWidth + "," + iPad) ; 
